...
INSERT INTO `mydb`.`USER` (`FIRST_NAME`, `LAST_NAME`, `EMAIL`, `PASSWORD`, `STATUS`, `TYPE`, `CREATION_DATE`) 
      VALUES ('Paruyr', 'Hovakimyan', 'paruyrhovakimyan@gmail.com', 'paruyr.password',  1, 1, UNIX_TIMESTAMP(NOW())),
             ...
             ('Anna', 'Xukasyan', 'annaxukasyan@gmail.com', 'anna.password',  1, 1, UNIX_TIMESTAMP(NOW())),
             ('Ara', 'Melqonyan', 'aramelqonyan@gmail.com', 'ara.password',  1, 1, UNIX_TIMESTAMP(NOW())),
              
             ('Gor', 'Hakobyan', 'gorhakobiann@gmail.com', 'gor-2000.password', 1, 2, UNIX_TIMESTAMP(NOW())),
             ('Narek', 'Malkhasyan', 'narekmalkhasyan@gmail.com', 'narek.password', 1, 2, UNIX_TIMESTAMP(NOW())),
             ('Gevorg', 'Ghazaryan', 'gevorgghazaryan@gmail.com', 'gevorg.password', 1, 2, UNIX_TIMESTAMP(NOW())),
             ('Tigranuhi', 'Mkrtchyan', 'tigranuhimkrtchyan@gmail.com', 'tigranuhi.password', 1, 2, UNIX_TIMESTAMP(NOW())),
             ('Vazken', 'Abdulyan', 'vazkhenabdulyan@gmail.com', 'vazkhen.password', 1, 2, UNIX_TIMESTAMP(NOW())),
             ('Armen', 'Gexamyan', 'armengexamyan@gmail.com', 'armen.password', 1, 2, UNIX_TIMESTAMP(NOW())),
             ('Anna', 'Harutyunyan', 'annaharutyunyan@gmail.com', 'anna.password', 1, 2, UNIX_TIMESTAMP(NOW())),
             ('Tigran', 'Qeshishyan', 'tigranqeshishyan@gmail.com', 'tigran.password', 1, 2, UNIX_TIMESTAMP(NOW())),
             ('Albert', 'Avagyan', 'albertavagyan@gmail.com', 'albert.password', 1, 2, UNIX_TIMESTAMP(NOW())),
             ('Narine', 'Minasyan', 'narineminasyan@gmail.com', 'narine.password', 1, 2, UNIX_TIMESTAMP(NOW())),
             ('Vergine', 'Hakobyan', 'verginehakobyan@gmail.com', 'vergine.password', 1, 2, UNIX_TIMESTAMP(NOW())),
             ('Karine', 'Baxramyan', 'karinebaxramyan@gmail.com', 'karine.password', 1, 2, UNIX_TIMESTAMP(NOW())),
             ('Armen', 'Jamkochyan', 'armenjamkochyan@gmail.com', 'armen.password', 1, 2, UNIX_TIMESTAMP(NOW())),
             ('Gayane', 'Tovmasyan', 'gayanetovmasyan@gmail.com', 'gayane.password', 1, 2, UNIX_TIMESTAMP(NOW())),
             ('Anjelika', 'Arzumanyan', 'anjelikaarzumanyan@gmail.com', 'anjelika.password', 1, 2, UNIX_TIMESTAMP(NOW())),
             ('Lilit', 'Gexamyan', 'lilitgexamyan@gmail.com', 'lilit.password', 1, 2, UNIX_TIMESTAMP(NOW())),
             ('Mxitar', 'Ohanyan', 'mxitarohanyan@gmail.com', 'mxitar.password', 1, 2, UNIX_TIMESTAMP(NOW())),
             ('Mher', 'Ohanyan', 'mherohanyan@gmail.com', 'mher.password', 1, 2, UNIX_TIMESTAMP(NOW())),
             ('Hayk', 'Sardaryan', 'hayksardaryan@gmail.com', 'hayk.password', 1, 2, UNIX_TIMESTAMP(NOW())),
             ('Davit', 'Adamyan', 'davitadamyan@gmail.com', 'davit.password', 1, 2, UNIX_TIMESTAMP(NOW())),
             ('Samvel', 'Meliqyan', 'samvelmeliqyan@gmail.com', 'samvel.password', 1, 2, UNIX_TIMESTAMP(NOW()));
...
INSERT INTO `mydb`.`SCHEDULE_RECORD` (`GROUP_COURSE_ID`, `CLASSROOM_ID`, `LESSON_ID`, `START_DATE`, `END_DATE`, `CREATION_DATE`) 
	  VALUES (1, 3, 1, 1567724468, 1567724468, UNIX_TIMESTAMP(NOW()));            
