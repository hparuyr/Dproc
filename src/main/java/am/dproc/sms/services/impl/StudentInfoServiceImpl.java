...
public class StudentInfoServiceImpl implements StudentInfoService{
	...
	public Integer updateStudentInfo(StudentInfo studentInfo) {
		if (studentInfo.getPassportId() != null) {
			return this.studentInfo.updateStudentInfoPassportId(studentInfo.getStudentId(), studentInfo.getPassportId());
		} else if (studentInfo.getSocialCardId() != null) {
			return this.studentInfo.updateStudentInfoSocialCardId(studentInfo.getStudentId(), studentInfo.getSocialCardId());
