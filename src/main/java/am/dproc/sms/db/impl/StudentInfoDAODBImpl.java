...
public class StudentInfoDAODBImpl implements StudentInfoDAO{
	...
	public Integer addStudentInfo(StudentInfo studentInfo) {
		...
		return jdbctemplate.update(ADD_STUDENT_INFO,new Object[] {studentInfo.getPassportId(), studentInfo.getSocialCardId(), studentInfo.getBirthDate(),
	...
	public Integer updateStudentInfoPassportId(Integer studentId, Integer passportId) {
		Long currentTimeMillis = new java.util.Date().getTime();
		return jdbctemplate.update(UPDATE_STUDENT_INFO_PASSPORT_ID, new Object[] { passportId, currentTimeMillis, studentId });
	}

	@Override
	public Integer updateStudentInfoSocialCardId(Integer studentId, Integer socialCardId) {
		Long currentTimeMillis = new java.util.Date().getTime();
		return jdbctemplate.update(UPDATE_STUDENT_INFO_SOCIAL_CARD_ID, new Object[] { socialCardId, currentTimeMillis, studentId });
	}

	@Override
	public Integer updateStudentInfoBirthDate(Integer studentId, Long birthDate) {
		Long currentTimeMillis = new java.util.Date().getTime();
		return jdbctemplate.update(UPDATE_STUDENT_INFO_BIRTH_DATE, new Object[] { birthDate, currentTimeMillis, studentId });
	}

	@Override
	public Integer updateStudentInfoImageUrl(Integer studentId, String imageUrl) {
		Long currentTimeMillis = new java.util.Date().getTime();
		return jdbctemplate.update(UPDATE_STUDENT_INFO_IMAGE_URL, new Object[] { imageUrl, currentTimeMillis, studentId });
	}
