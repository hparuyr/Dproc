...
public class AdminInfoDAODBImpl implements AdminInfoDAO{
	...
	public Integer addAdminInfo(AdminInfo adminInfo) {
		...
		return jdbctemplate.update(ADD_ADMIN_INFO,new Object[] {adminInfo.getPassportId(), adminInfo.getSocialCardId(), adminInfo.getBirthDate(),
	...
	public Integer updateAdminInfoPassportId(Integer adminId, Integer passportId) {
		Long currentTimeMillis = new java.util.Date().getTime();
		return jdbctemplate.update(UPDATE_ADMIN_INFO_PASSPORT_ID, new Object[] { passportId, currentTimeMillis, adminId });
	}

	@Override
	public Integer updateAdminInfoSocialCardId(Integer adminId, Integer socialCardId) {
		Long currentTimeMillis = new java.util.Date().getTime();
		return jdbctemplate.update(UPDATE_ADMIN_INFO_SOCIAL_CARD_ID, new Object[] { socialCardId, currentTimeMillis, adminId });
	}

	@Override
	public Integer updateAdminInfoBirthDate(Integer adminId, Long birthDate) {
		Long currentTimeMillis = new java.util.Date().getTime();
		return jdbctemplate.update(UPDATE_ADMIN_INFO_BIRTH_DATE, new Object[] { birthDate, currentTimeMillis, adminId });
	}
	@Override
