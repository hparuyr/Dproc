...
import am.dproc.sms.db.root.TeacherInfoDAO;
...
public class TeacherInfoDAODBImpl implements TeacherInfoDAO{
	...
	public Integer addTeacherInfo(TeacherInfo teacherInfo) {
		...
		return jdbctemplate.update(ADD_TEACHER_INFO,new Object[] {teacherInfo.getPassportId(), teacherInfo.getSocialCardId(), teacherInfo.getBirthDate(),
	...
	public Integer updateTeacherInfoPassportId(Integer teacherId, Integer passportId) {
		Long currentTimeMillis = new java.util.Date().getTime();
		return jdbctemplate.update(UPDATE_TEACHER_INFO_PASSPORT_ID, new Object[] { passportId, currentTimeMillis, teacherId });
	}

	@Override
	public Integer updateTeacherInfoSocialCardId(Integer teacherId, Integer socialCardId) {
		Long currentTimeMillis = new java.util.Date().getTime();
		return jdbctemplate.update(UPDATE_TEACHER_INFO_SOCIAL_CARD_ID, new Object[] { socialCardId, currentTimeMillis, teacherId });
	}

	@Override
	public Integer updateTeacherInfoBirthDate(Integer teacherId, Long birthDate) {
		Long currentTimeMillis = new java.util.Date().getTime();
		return jdbctemplate.update(UPDATE_TEACHER_INFO_BIRTH_DATE, new Object[] { birthDate, currentTimeMillis, teacherId });
	}

	@Override
	public Integer updateTeacherInfoImageUrl(Integer teacherId, String imageUrl) {
		Long currentTimeMillis = new java.util.Date().getTime();
		return jdbctemplate.update(UPDATE_TEACHER_INFO_IMAGE_URL, new Object[] { imageUrl, currentTimeMillis, teacherId });
	}
