...
public class TeacherDAODBImpl implements TeacherDAO{
	...
	public Integer addTeacher(Teacher teacher) {
		...
		return jdbctemplate.update(ADD_TEACHER,new Object[] { teacher.getName(), teacher.getSurname(), teacher.getEmail(),
			teacher.getPassword(), currentTimeMillis, currentTimeMillis, teacher.getSchoolId(),});
	}
	@Override
