...
public class TeacherDAODBImpl implements TeacherDAO {
    ...
    public Integer addTeacher(Teacher teacher) {
        ...
        return jdbctemplate.update(ADD_TEACHER,
                teacher.getName(), teacher.getSurname(), teacher.getEmail(), teacher.getPassword(),
    ...
    public Integer updateTeacherName(Integer id, String name) {
        return jdbctemplate.update(UPDATE_TEACHER_NAME, name, System.currentTimeMillis(), id);
    }

    @Override
    public Integer updateTeacherSurname(Integer id, String surname) {
        return jdbctemplate.update(UPDATE_TEACHER_SURNAME, surname, System.currentTimeMillis(), id);
    }

    @Override
    public Integer updateTeacherEmail(Integer id, String email) {
        return jdbctemplate.update(UPDATE_TEACHER_EMAIL, email, System.currentTimeMillis(), id);
    }

    @Override
    public Integer updateTeacherPassword(Integer id, String password) {
        return jdbctemplate.update(UPDATE_TEACHER_PASSWORD, password, System.currentTimeMillis(), id);
    }

    @Override
    public Integer updateTeacherSchoolId(Integer id, Integer schoolId) {
        return jdbctemplate.update(UPDATE_TEACHER_SCHOOL_ID, schoolId, System.currentTimeMillis(), id);
    }
