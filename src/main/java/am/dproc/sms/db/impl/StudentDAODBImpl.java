...
public class StudentDAODBImpl implements StudentDAO{
	...
	public Integer addStudent(Student student) {
		...
		return jdbctemplate.update(ADD_STUDENT,new Object[] { student.getName(), student.getSurname(),student.getEmail(),
			student.getPassword(), student.getStatus(),currentTimeMillis, currentTimeMillis, student.getGroupId()});
	}
	@Override
